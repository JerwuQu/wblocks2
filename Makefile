...
$(PROJ).exe: $(SRC) $(DEP) wblocks.res
	x86_64-w64-mingw32-gcc -std=c++20 -O2 -Wall -Wl,-subsystem,windows -Iquickjs/include -Lquickjs/lib/quickjs -o $@ $(SRC) wblocks.res -static -lstdc++ -lgdi32 -lquickjs -pthread
